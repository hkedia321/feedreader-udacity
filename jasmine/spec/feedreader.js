    ...
    describe('RSS Feeds', function() {
         ...
         */
         it('URL is defined and it is not empty', function() {
            for(var loop = 0; loop < allFeeds.length; loop++) {
                expect(allFeeds[loop].url).toBeDefined();
                expect(allFeeds[loop].url.length).not.toBe(0);
            }
        });
         ...
         */
         it('name is defined and it is not empty', function() {
            for(var loop = 0; loop < allFeeds.length; loop++) {
                ...
                expect(allFeeds[loop].name.length).not.toBe(0);
            }
        });
     });
    ...
    describe('Initial Entries', function() {
         ...
         */
         it('should contain at least one single .entry element', function(done) {
            var feeds = $('.feed .entry')[0];
            expect(feeds).toBeGreaterThan('');
            done();
        });
     });
